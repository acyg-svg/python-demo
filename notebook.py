...
def author():
    showinfo(title="作者",message="陈奕耿")

def power():
    showinfo(title="版权信息",message="1840706138 18web1班陈奕耿")
...
tupian=Menu(top)
tupian.add_command(label="图片编辑",command=tupian)
menubar.add_cascade(label="图片编辑",menu=tupian)
top['menu']=menubar
